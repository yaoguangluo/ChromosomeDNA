##### 权限申明
	...
	5.1 早期的 直接下了改 商业用 没问题。 要公开严谨refer 告知作者。否则视为侵权。                    
	5.2 早期的 直接下了改商业用 并翻译成其他计算机语言也 没问题。 要公开严谨refer 告知作者。否则视为侵权。                   
	5.3 直接下了改商业用 并用元基催化技术改， 就得GPL2.0开源。要公开严谨refer 告知作者。否则视为侵权。                     
	5.4 直接下了改商业用 并用元基催化技术改， 又不想GPL2.0开源 。 就只能用华瑞集染色体插件包。 要公开严谨refer 告知作者。否则视为侵权。                  
