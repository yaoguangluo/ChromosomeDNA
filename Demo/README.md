##### 权限申明
	...
	5举个例子，比如分词：       
	5.1 直接下了改 商业用 没问题。 要公开严谨refer 告知作者。          
	5.2 直接下了改商业用 并翻译成其他计算机语言也 没问题。 要公开严谨refer 告知作者。           
	5.3 直接下了改商业用 并用元基催化技术改， 就得GPL2.0开源。告知作者。            
	5.4 直接下了改商业用 并用元基催化技术改， 又不想GPL2.0开源 。 就只能用华瑞集染色体插件包。 告知作者。          
	5.5 直接下了改商业用 并用元基催化技术改， 还翻译成其他计算机语言， 属于著作权销售转让租用范畴。请求作者授权，同时GPL2.0开源。               
