...
![](https://img.shields.io/badge/API-V5019666-green.svg)
...
#### 核心贡献
	...
	1 Java api https://github.com/yaoguangluo/ChromosomeDNA/blob/main/2025/华瑞集5019666_core.jar
	1.1 jar api 大小仅仅2兆， 其中class文件 含有完整 阅读source 对应，含前端门户测试实例的综合大小 仅仅3.9兆。 
...
#### 核心价值
	...
	2 单机联想Y7000笔记本win10 实测峰值每秒 double高精度数组 每秒可排序1150万，准确率100% 见top sort 5代 100%完整开放源码，在api与书籍中。--当前版本不断元基编码化，损失一定性能，可见当年的老版本。
...
#### 使用方法
	...
	Demo真实源码调用实例 见 https://github.com/yaoguangluo/ChromosomeDNA/tree/main/Demo
 	最新API见 https://github.com/yaoguangluo/ChromosomeDNA/blob/main/2025/华瑞集5019666_core.jar 
