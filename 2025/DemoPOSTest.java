        ...
        for (int j = 0; j < 1; j++) {
            for (int i = 0; i < sets.size(); i++) {
                ...
                if (!string.replaceAll("\\s+", "").equals("")) {
                    ...
                    if (wordPOS.contains("形")||wordPOS.contains("副")) {
                        if (i + 1 < sets.size()) {
                            ...
                            if (null != wordNextObjectPOS) {
                                ...
                                if (wordNext.contains("地") || wordNextPOS.contains("动")) {
                                    wordPOS = "副词";
                                }else{
                                    if (wordNext.contains("的") || wordNextPOS.contains("名")) {
                                        wordPOS = "形容词";
                                    }
                                }
                            }
...
//输出观测
//Connected to the target VM, address: '127.0.0.1:61372', transport: 'socket'
//-展示词性-
//罗瑶光/人物名词----先生/名词----从/介词----年/量词----10/数词----月/名词----开始/动词----，
// /标点----所有/名词----个人/名词----著作权/名词----作品/名词----，/标点----全部/副词----开源/未知-
// ---，/标点----到/动词----现在/时态词----，/标点----无数/数词----群体/未知----，/标点----技术/名词
// ----社团/名词----正面/名词----交锋/未知----7/名词----年/量词----，/标点----一直/形容词--
// --0/名词----纠纷/名词----，/标点----罗瑶光/人物名词----先生/名词----认为/动词----，/标点--
// --一件/未知----作品/名词----，/标点----一个/量词----事/名词----物/名词----，/标点----如果/从属连词-
// ---有/动词----价值/名词----，/标点----就/副词----应该/情态词----像/形容词----教材/名词---
// -一样/形谓词----在/介词----真实/形容词----的/结构助词----环境/名词----中/定名词----实践/名词---
// -测试/动词----和/并列连词----论证/名词----，/标点----能/情态词----经得起/未知----所有/名词--
// --人/名词----长年累月/名词----
//不断/副词----地/副词----挑剔/动词----的/结构助词----东西/名词----，/标点----才是/副词---
// -货真价实/未知----的/结构助词----，/标点----罗瑶光/人物名词----的/结构助词----个人/名词---
// -著作权/名词----作品/名词----都是/形容词----互联网/名词----，/标点----大/形容词----数据/名词---
...
//--词汇->一直-词性->形容词-平均距离->30-出现频率->1.0
//--词汇->像-词性->形容词-平均距离->51-出现频率->1.0
//--词汇->一样-词性->null-平均距离->53-出现频率->1.0
//--词汇->真实-词性->形容词-平均距离->55-出现频率->1.0
//--词汇->都是-词性->形容词-平均距离->84-出现频率->1.0
...
//--词汇->才是-词性->null-平均距离->75-出现频率->1.0Disconnected from the target VM, address: '127.0.0.1:61372', transport: 'socket'
//
