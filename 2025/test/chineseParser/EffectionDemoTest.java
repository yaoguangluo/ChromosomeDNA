 ...
 * */
class EffectionDemoTest {
    /* 著作权算法的动态用法
     * 探索自然语言写作质量痕迹归纳。例子是名词思维在写作中的轨迹变化的切裂方式，用于探索大脑的思绪记忆变化频率。
     * --分词后输出格式化按行长增维进行词性词团--先-3.4 分词归纳-再通过-1.3 scale 距离来进行 坐标团切裂。
     * --该测试DEMO用于公文申请书类优化，适用于高等院校进修材料，留学申请，写作优化，
     * --写作习惯，写作特征分析等办公学习场景，适用于教育和传媒宣传领域。
    ...
    void main() {
        ...
        //计算
        //处理fissile
        int scale = weight / 3; //可根据 2D词汇的一行含量来进行精度设置，增加观测质量。我才用正方体除3的9等分。
        System.out.println("精度->" + scale);
        Map<Double, List<AMV_MVS_VSQ_2D>> output = Fissile_X_fissilePosition2D._E(inputNoun, scale);
        //颜色显示
...
//输出结果
//Connected to the target VM, address: '127.0.0.1:52664', transport: 'socket'
//    文字长度->839
//    分词词汇数->479
//    分词词汇增维宽度->21
//    分词词汇增维长度->23
...
//    -97-97-97-------------------------------98-98-99-99-99-99-99----99---
//    -------97-97-------------98-98-98----98-98-99----------99------------
...
//    -------------------------------99----99-99-------99------------------
//    ----95-------------------------------99------------------------------
//    -95----95----------98-98----------------------99-------99-99---------
//    -95----------98----------------------------------99-------------99---
//    -------------98----------------------------99-------99---------------
//    ----------------------------------------------------99-99------------
//    ----------98-------------------------------------99----99-99---------
//    -------------------------98-98----------99-99------------------------
//    Disconnected from the target VM, address: '127.0.0.1:52664', transport: 'socket'
//
