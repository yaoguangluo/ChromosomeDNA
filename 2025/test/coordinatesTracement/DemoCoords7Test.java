 ...
 * */
/*
 * 这是一个 /处理fusion 先 fissile 采样 然后fusion 1 观测heart 再 Fusion_X_fusionPosition2DwithHeart
...
//		//2观测结果 用10 和11分别带入可测试。
        Map<Double, List<AMV_MVS_VSQ_2D>> fusion = Fusion_X_fusionPosition2DwithHeart._E(output
            , groupsHeart, 11);
